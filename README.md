...
![Open LUA Console](.docs/Tools_LUA_Console.png)

Once you have the `LUA Console` opened, go to `Script` -> `Open script` and select the `.lua` file you want.

![Import script](.docs/Scripts_Open_Script.png)

Don't forget to keep the `LUA Console` tab opened to keep the script active!

If you can't launch the script, make sure LiveSplit is open.

![Script launched](.docs/Script_Launched.png)
